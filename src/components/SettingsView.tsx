...
import { getPresetModels } from "@/components/ChatInterface";
    ...
    <div className="flex h-full w-full bg-zinc-50 dark:bg-[#09090b] text-zinc-900 dark:text-zinc-200 font-sans overflow-hidden transition-colors duration-200">
      ...
      <div className="flex-1 bg-zinc-50 dark:bg-black flex flex-col overflow-hidden transition-colors duration-200">
        ...
        >
          {/* GENERAL TAB */}
          <div
            className={`max-w-4xl space-y-6 ${activeTab === "general" ? "block" : "hidden"}`}
          >
            <div className="mb-2">
          ...
          {/* ACCOUNT TAB */}
          <div
            className={`max-w-4xl ${activeTab === "account" ? "block" : "hidden"}`}
          >
          ...
          {/* TOOLS TAB (MCP) */}
          <div
            className={`max-w-4xl space-y-6 ${activeTab === "tools" ? "block" : "hidden"}`}
          >
          ...
          {/* AGENT TAB */}
          <div
            className={`max-w-4xl space-y-6 ${activeTab === "agent" ? "block" : "hidden"}`}
          >
            <div className="flex justify-between items-center mb-6">
              <div>
                <p className="text-zinc-500 dark:text-zinc-400 text-sm">
                        ...
                        {editingAgentId === agent.id ? (
                          <div className="flex items-center gap-2">
                            <input
                              ...
                              onChange={(e) =>
                                setEditingAgentName(e.target.value)
                              }
          ...
          {/* LANGFLOW TAB */}
          <div
            className={`flex flex-col h-full ${activeTab === "langflow" ? "block" : "hidden"}`}
          >
            {/* Iframe */}
